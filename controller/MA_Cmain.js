...
exports.kakao_get = (req, res)=>{
    res.redirect(`https://kauth.kakao.com/oauth/authorize?client_id=${kakao.clientID}&redirect_uri=${kakao.redirectUri}&response_type=code&scope=profile_nickname,account_email`)
}
//카카오 로그인 응답받기
...
exports.google_get = (req, res)=>{
    res.redirect(`https://accounts.google.com/o/oauth2/v2/auth?client_id=${google.clientID}&redirect_uri=${google.redirectUri}&response_type=code&scope=email profile`)
